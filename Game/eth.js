...
var tokenAbi = [
  ...
  var token = new web3.eth.Contract(tokenAbi, '0x7ea8B2C3C4C9B7fC54bcbDB9514768784081706A');
  var marketplace = new web3.eth.Contract(marketplaceAbi, '0x1d4eA6fc92811eCc9e7e3C1be9A1265fbF4112dc');
  ...
  function buy(id) {
      web3.eth.getAccounts().then(accounts => {
          ...
          marketplace.methods.buyToken(id)
          .send(options).on('reciept', reciept => {
